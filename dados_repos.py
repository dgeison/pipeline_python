...
class DadosRepositorios:
    ...
    def lista_repositorios(self):
        """
        Fetches a list of repositories for the given owner.

        Returns:
            A list of repositories. Each repository is represented as a JSON object.
        """
        repos_list = []
    ...
    def nomes_repos(self, repos_list):
        """
        Generate the names of the repositories given a list of repositories.

        Args:
            repos_list (list): A list of repositories.
    ...
    def nomes_linguagens(self, repos_list):
        """
        Returns a list of languages used in the given list of repositories.

        Parameters:
            repos_list (list): A list of dictionaries representing repositories.

        Returns:
            list: A list of strings representing the languages used in the repositories.
        """
        repo_languages = []
        for page in repos_list:
            for repo in page:
    ...
    def cria_df_linguagens(self):
        """
        Generates a DataFrame containing the repository names and the corresponding programming languages.

        Returns:
            pandas.DataFrame: The DataFrame with the repository names and programming languages.
        """
