...
class ManipulaRepositorios:
    def __init__(self, username):
        ...
        self.access_token = "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"
        self.headers = {
...
novo_repo = ManipulaRepositorios("dgeison")
...
novo_repo.add_arquivo(
    nome_repo, "linguagens_netflix.csv", "dados/linguagens_netflix.csv"
)
novo_repo.add_arquivo(
    nome_repo, "linguagens_spotify.csv", "dados/linguagens_spotify.csv"
)
